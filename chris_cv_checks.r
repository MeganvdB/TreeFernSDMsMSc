...
# 3.2 stratified selection (geographic)
...
allModels<- c("GLM", "GBM", "GAM", "CTA", "ANN", "SRE", "FDA", "MARS", "RF", "MAXENT"),
...
# myBiomodModelOutcvs <- BIOMOD_Modeling(bm.format = myBiomodData,
#                                     modeling.id = "cv.s",
#                                     models = allModels,
#                                     CV.strategy = "strat",
#                                     CV.perc = 0.80,
...
# myCalibLinescvs <- get_calib_lines(myBiomodModelOutcvs)
# plot(myBiomodData, calib.lines = myCalibLinescvs)


# myBiomodModelOutcve <- BIOMOD_Modeling(bm.format = myBiomodData,
#                                     modeling.id = "cv.e",
#                                     models = allModels,
#                                     CV.strategy = "env",
#                                     CV.perc = 0.80,
...
# myCalibLinescve <- get_calib_lines(myBiomodModelOutcve)
# plot(myBiomodData, calib.lines = myCalibLinescve)
...
myBiomodModelOut_scores
write.csv(myBiomodModelOut_scores, file = "myBiomodModelOut_scores.csv", row.names = FALSE)
...
SpheCoop_glm_subset <- get_built_models(myBiomodModelOut, algo = 'GLM')
...
SpheCoop_ann_subset <- get_built_models(myBiomodModelOut, algo = 'ANN')
...
SpheCoop_gbm_subset <- get_built_models(myBiomodModelOut, algo = 'GBM')
...
SpheCoop_gam_subset <- get_built_models(myBiomodModelOut, algo = 'GAM')
...
SpheCoop_cta_subset <- get_built_models(myBiomodModelOut, algo = 'CTA')
...
SpheCoop_fda_subset <- get_built_models(myBiomodModelOut, algo = 'FDA')
...
SpheCoop_mars_subset <- get_built_models(myBiomodModelOut, algo = 'MARS')
...
SpheCoop_maxent_subset <- get_built_models(myBiomodModelOut, algo = 'MAXENT')
...
write.csv(ensemble_score_csv, file = "ch_SpheCoop_ensemble-evaluations.csv", row.names = FALSE)
...
GR_SpheCoop_proj_ensemble_current <- BIOMOD_EnsembleForecasting(
...
REU_SpheCoop_proj_ensemble_current <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_current,
...
GR_SpheCoop_proj_ensemble_2040_126_GFDL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2040_126_GFDL,
...
GR_SpheCoop_proj_ensemble_2100_126_GFDL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2100_126_GFDL,
                        projection.output = GR_SpheCoop_proj_2040_126_GFDL,
...
GR_SpheCoop_proj_ensemble_2040_585_GFDL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2040_585_GFDL,
...
GR_SpheCoop_proj_ensemble_2100_585_GFDL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2100_585_GFDL,
                        projection.output = GR_SpheCoop_proj_2040_585_GFDL,
...
GR_stk_SpheCoop_ef_current_GFDL <- get_predictions(GR_SpheCoop_proj_ensemble_current)
plot(GR_stk_SpheCoop_ef_current_GFDL)
GR_stk_SpheCoop_ef_2040_126_GFDL <- get_predictions(GR_SpheCoop_proj_ensemble_2040_126_GFDL)
plot(GR_stk_SpheCoop_ef_2040_126_GFDL)
GR_stk_SpheCoop_ef_2100_126_GFDL <- get_predictions(GR_SpheCoop_proj_ensemble_2100_126_GFDL)
plot(GR_stk_SpheCoop_ef_2100_126_GFDL)
GR_stk_SpheCoop_ef_2040_585_GFDL <- get_predictions(GR_SpheCoop_proj_ensemble_2040_585_GFDL)
plot(GR_stk_SpheCoop_ef_2040_585_GFDL)
GR_stk_SpheCoop_ef_2100_585_GFDL <- get_predictions(GR_SpheCoop_proj_ensemble_2100_585_GFDL)
plot(GR_stk_SpheCoop_ef_2100_585_GFDL)

# Set it to only use EMca and EMwmean
subset(GR_stk_SpheCoop_ef_current_GFDL ,grep('EMwmean', names(GR_stk_SpheCoop_ef_current_GFDL )))
subset(GR_stk_SpheCoop_ef_2040_126_GFDL ,grep('EMwmean', names(GR_stk_SpheCoop_ef_2040_126_GFDL )))
subset(GR_stk_SpheCoop_ef_2100_126_GFDL ,grep('EMwmean', names(GR_stk_SpheCoop_ef_2100_126_GFDL )))
subset(GR_stk_SpheCoop_ef_2040_585_GFDL ,grep('EMwmean', names(GR_stk_SpheCoop_ef_2040_585_GFDL )))
subset(GR_stk_SpheCoop_ef_2100_585_GFDL ,grep('EMwmean', names(GR_stk_SpheCoop_ef_2100_585_GFDL )))
...
REU_SpheCoop_proj_ensemble_2040_126_GFDL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2040_126_GFDL,
...
REU_SpheCoop_proj_ensemble_2100_126_GFDL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2100_126_GFDL,
...
REU_SpheCoop_proj_ensemble_2040_585_GFDL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2040_585_GFDL,
...
REU_SpheCoop_proj_ensemble_2100_585_GFDL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2100_585_GFDL,
...
#---------------------------------------------------------
# Get the ensemble models projection stack
REU_stk_SpheCoop_ef_current_GFDL <- get_predictions(REU_SpheCoop_proj_ensemble_current)
plot(REU_stk_SpheCoop_ef_current_GFDL)
REU_stk_SpheCoop_ef_2040_126_GFDL <- get_predictions(REU_SpheCoop_proj_ensemble_2040_126_GFDL)
plot(REU_stk_SpheCoop_ef_2040_126_GFDL)
REU_stk_SpheCoop_ef_2100_126_GFDL <- get_predictions(REU_SpheCoop_proj_ensemble_2100_126_GFDL)
plot(REU_stk_SpheCoop_ef_2100_126_GFDL)
REU_stk_SpheCoop_ef_2040_585_GFDL <- get_predictions(REU_SpheCoop_proj_ensemble_2040_585_GFDL)
plot(REU_stk_SpheCoop_ef_2040_585_GFDL)
REU_stk_SpheCoop_ef_2100_585_GFDL <- get_predictions(REU_SpheCoop_proj_ensemble_2100_585_GFDL)
plot(REU_stk_SpheCoop_ef_2100_585_GFDL)

# Set it to only use EMca and EMwmean
subset(REU_stk_SpheCoop_ef_current_GFDL ,grep('EMwmean', names(REU_stk_SpheCoop_ef_current_GFDL )))
subset(REU_stk_SpheCoop_ef_2040_126_GFDL ,grep('EMwmean', names(REU_stk_SpheCoop_ef_2040_126_GFDL )))
subset(REU_stk_SpheCoop_ef_2100_126_GFDL ,grep('EMwmean', names(REU_stk_SpheCoop_ef_2100_126_GFDL )))
subset(REU_stk_SpheCoop_ef_2040_585_GFDL ,grep('EMwmean', names(REU_stk_SpheCoop_ef_2040_585_GFDL )))
subset(REU_stk_SpheCoop_ef_2100_585_GFDL ,grep('EMwmean', names(REU_stk_SpheCoop_ef_2100_585_GFDL )))
...
GR_SpheCoop_proj_ensemble_2040_126_IPSL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2040_126_IPSL,
...
GR_SpheCoop_proj_ensemble_2100_126_IPSL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2100_126_IPSL,
                        projection.output = GR_SpheCoop_proj_2040_126_IPSL,
...
GR_SpheCoop_proj_ensemble_2040_585_IPSL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2040_585_IPSL,
...
GR_SpheCoop_proj_ensemble_2100_585_IPSL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2100_585_IPSL,
                        projection.output = GR_SpheCoop_proj_2040_585_IPSL,
...
#---------------------------------------------------------
# Get the ensemble models projection stack
GR_stk_SpheCoop_ef_current_IPSL <- get_predictions(GR_SpheCoop_proj_ensemble_current)
plot(GR_stk_SpheCoop_ef_current_IPSL)
GR_stk_SpheCoop_ef_2040_126_IPSL <- get_predictions(GR_SpheCoop_proj_ensemble_2040_126_IPSL)
plot(GR_stk_SpheCoop_ef_2040_126_IPSL)
GR_stk_SpheCoop_ef_2100_126_IPSL <- get_predictions(GR_SpheCoop_proj_ensemble_2100_126_IPSL)
plot(GR_stk_SpheCoop_ef_2100_126_IPSL)
GR_stk_SpheCoop_ef_2040_585_IPSL <- get_predictions(GR_SpheCoop_proj_ensemble_2040_585_IPSL)
plot(GR_stk_SpheCoop_ef_2040_585_IPSL)
GR_stk_SpheCoop_ef_2100_585_IPSL <- get_predictions(GR_SpheCoop_proj_ensemble_2100_585_IPSL)
...
REU_SpheCoop_proj_ensemble_2040_126_IPSL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2040_126_IPSL,
...
REU_SpheCoop_proj_ensemble_2100_126_IPSL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2100_126_IPSL,
...
REU_SpheCoop_proj_ensemble_2040_585_IPSL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2040_585_IPSL,
...
REU_SpheCoop_proj_ensemble_2100_585_IPSL <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2100_585_IPSL,
...
#---------------------------------------------------------
# Get the ensemble models projection stack
REU_stk_SpheCoop_ef_current_IPSL <- get_predictions(REU_SpheCoop_proj_ensemble_current)
plot(REU_stk_SpheCoop_ef_current_IPSL)
REU_stk_SpheCoop_ef_2040_126_IPSL <- get_predictions(REU_SpheCoop_proj_ensemble_2040_126_IPSL)
plot(REU_stk_SpheCoop_ef_2040_126_IPSL)
REU_stk_SpheCoop_ef_2100_126_IPSL <- get_predictions(REU_SpheCoop_proj_ensemble_2100_126_IPSL)
plot(REU_stk_SpheCoop_ef_2100_126_IPSL)
REU_stk_SpheCoop_ef_2040_585_IPSL <- get_predictions(REU_SpheCoop_proj_ensemble_2040_585_IPSL)
plot(REU_stk_SpheCoop_ef_2040_585_IPSL)
REU_stk_SpheCoop_ef_2100_585_IPSL <- get_predictions(REU_SpheCoop_proj_ensemble_2100_585_IPSL)
...
#---------------------------------------------------------
# Load future data ssp126
bio1_GR_2040_126_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp126\\2041-2070\\bio1_2041-2070_mri-esm2-0_ssp126_V.2.1_GR.tif")
bio4_GR_2040_126_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp126\\2041-2070\\bio4_2041-2070_mri-esm2-0_ssp126_V.2.1_GR.tif")
bio10_GR_2040_126_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp126\\2041-2070\\bio10_2041-2070_mri-esm2-0_ssp126_V.2.1_GR.tif")
bio11_GR_2040_126_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp126\\2041-2070\\bio11_2041-2070_mri-esm2-0_ssp126_V.2.1_GR.tif")
bio15_GR_2040_126_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp126\\2041-2070\\bio15_2041-2070_mri-esm2-0_ssp126_V.2.1_GR.tif")
bio16_GR_2040_126_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp126\\2041-2070\\bio16_2041-2070_mri-esm2-0_ssp126_V.2.1_GR.tif")
bio17_GR_2040_126_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp126\\2041-2070\\bio17_2041-2070_mri-esm2-0_ssp126_V.2.1_GR.tif")

bio1_GR_2100_126_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp126\\2071-2100\\bio1_2071-2100_mri-esm2-0_ssp126_V.2.1_GR.tif")
bio4_GR_2100_126_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp126\\2071-2100\\bio4_2071-2100_mri-esm2-0_ssp126_V.2.1_GR.tif")
bio10_GR_2100_126_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp126\\2071-2100\\bio10_2071-2100_mri-esm2-0_ssp126_V.2.1_GR.tif")
bio11_GR_2100_126_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp126\\2071-2100\\bio11_2071-2100_mri-esm2-0_ssp126_V.2.1_GR.tif")
bio15_GR_2100_126_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp126\\2071-2100\\bio15_2071-2100_mri-esm2-0_ssp126_V.2.1_GR.tif")
bio16_GR_2100_126_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp126\\2071-2100\\bio16_2071-2100_mri-esm2-0_ssp126_V.2.1_GR.tif")
bio17_GR_2100_126_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp126\\2071-2100\\bio17_2071-2100_mri-esm2-0_ssp126_V.2.1_GR.tif")

# Load future data ssp585
bio1_GR_2040_585_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp585\\2041-2070\\bio1_2041-2070_mri-esm2-0_ssp585_V.2.1_GR.tif")
bio4_GR_2040_585_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp585\\2041-2070\\bio4_2041-2070_mri-esm2-0_ssp585_V.2.1_GR.tif")
bio10_GR_2040_585_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp585\\2041-2070\\bio10_2041-2070_mri-esm2-0_ssp585_V.2.1_GR.tif")
bio11_GR_2040_585_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp585\\2041-2070\\bio11_2041-2070_mri-esm2-0_ssp585_V.2.1_GR.tif")
bio15_GR_2040_585_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp585\\2041-2070\\bio15_2041-2070_mri-esm2-0_ssp585_V.2.1_GR.tif")
bio16_GR_2040_585_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp585\\2041-2070\\bio16_2041-2070_mri-esm2-0_ssp585_V.2.1_GR.tif")
bio17_GR_2040_585_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp585\\2041-2070\\bio17_2041-2070_mri-esm2-0_ssp585_V.2.1_GR.tif")

bio1_GR_2100_585_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp585\\2071-2100\\bio1_2071-2100_mri-esm2-0_ssp585_V.2.1_GR.tif")
bio4_GR_2100_585_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp585\\2071-2100\\bio4_2071-2100_mri-esm2-0_ssp585_V.2.1_GR.tif")
bio10_GR_2100_585_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp585\\2071-2100\\bio10_2071-2100_mri-esm2-0_ssp585_V.2.1_GR.tif")
bio11_GR_2100_585_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp585\\2071-2100\\bio11_2071-2100_mri-esm2-0_ssp585_V.2.1_GR.tif")
bio15_GR_2100_585_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp585\\2071-2100\\bio15_2071-2100_mri-esm2-0_ssp585_V.2.1_GR.tif")
bio16_GR_2100_585_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp585\\2071-2100\\bio16_2071-2100_mri-esm2-0_ssp585_V.2.1_GR.tif")
bio17_GR_2100_585_MRI <- raster("input_data\\climate_data\\MRI\\Garden route\\ssp585\\2071-2100\\bio17_2071-2100_mri-esm2-0_ssp585_V.2.1_GR.tif")
...
GR_SpheCoop_proj_ensemble_2040_126_MRI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2040_126_MRI,
...
GR_SpheCoop_proj_ensemble_2100_126_MRI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2100_126_MRI,
                        projection.output = GR_SpheCoop_proj_2040_126_MRI,
...
GR_SpheCoop_proj_ensemble_2040_585_MRI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2040_585_MRI,
...
GR_SpheCoop_proj_ensemble_2100_585_MRI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2100_585_MRI,
                        projection.output = GR_SpheCoop_proj_2040_585_MRI,
...
#---------------------------------------------------------
# Get the ensemble models projection stack
GR_stk_SpheCoop_ef_current_MRI <- get_predictions(GR_SpheCoop_proj_ensemble_current)
plot(GR_stk_SpheCoop_ef_current_MRI)
GR_stk_SpheCoop_ef_2040_126_MRI <- get_predictions(GR_SpheCoop_proj_ensemble_2040_126_MRI)
plot(GR_stk_SpheCoop_ef_2040_126_MRI)
GR_stk_SpheCoop_ef_2100_126_MRI <- get_predictions(GR_SpheCoop_proj_ensemble_2100_126_MRI)
plot(GR_stk_SpheCoop_ef_2100_126_MRI)
GR_stk_SpheCoop_ef_2040_585_MRI <- get_predictions(GR_SpheCoop_proj_ensemble_2040_585_MRI)
plot(GR_stk_SpheCoop_ef_2040_585_MRI)
GR_stk_SpheCoop_ef_2100_585_MRI <- get_predictions(GR_SpheCoop_proj_ensemble_2100_585_MRI)
plot(GR_stk_SpheCoop_ef_2100_585_MRI)

# Set it to only use EMca and EMwmean
subset(GR_stk_SpheCoop_ef_current_MRI ,grep('EMwmean', names(GR_stk_SpheCoop_ef_current_MRI )))
subset(GR_stk_SpheCoop_ef_2040_126_MRI ,grep('EMwmean', names(GR_stk_SpheCoop_ef_2040_126_MRI )))
subset(GR_stk_SpheCoop_ef_2100_126_MRI ,grep('EMwmean', names(GR_stk_SpheCoop_ef_2100_126_MRI )))
subset(GR_stk_SpheCoop_ef_2040_585_MRI ,grep('EMwmean', names(GR_stk_SpheCoop_ef_2040_585_MRI )))
subset(GR_stk_SpheCoop_ef_2100_585_MRI ,grep('EMwmean', names(GR_stk_SpheCoop_ef_2100_585_MRI )))
...
REU_SpheCoop_proj_ensemble_2040_126_MRI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2040_126_MRI,
...
REU_SpheCoop_proj_ensemble_2100_126_MRI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2100_126_MRI,
...
REU_SpheCoop_proj_ensemble_2040_585_MRI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2040_585_MRI,
...
REU_SpheCoop_proj_ensemble_2100_585_MRI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2100_585_MRI,
...
#---------------------------------------------------------
# Get the ensemble models projection stack
REU_stk_SpheCoop_ef_current_MRI <- get_predictions(REU_SpheCoop_proj_ensemble_current)
plot(REU_stk_SpheCoop_ef_current_MRI)
REU_stk_SpheCoop_ef_2040_126_MRI <- get_predictions(REU_SpheCoop_proj_ensemble_2040_126_MRI)
plot(REU_stk_SpheCoop_ef_2040_126_MRI)
REU_stk_SpheCoop_ef_2100_126_MRI <- get_predictions(REU_SpheCoop_proj_ensemble_2100_126_MRI)
plot(REU_stk_SpheCoop_ef_2100_126_MRI)
REU_stk_SpheCoop_ef_2040_585_MRI <- get_predictions(REU_SpheCoop_proj_ensemble_2040_585_MRI)
plot(REU_stk_SpheCoop_ef_2040_585_MRI)
REU_stk_SpheCoop_ef_2100_585_MRI <- get_predictions(REU_SpheCoop_proj_ensemble_2100_585_MRI)
...
GR_SpheCoop_proj_ensemble_2040_126_MPI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2040_126_MPI,
...
GR_SpheCoop_proj_ensemble_2100_126_MPI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2100_126_MPI,
                        projection.output = GR_SpheCoop_proj_2040_126_MPI,
...
GR_SpheCoop_proj_ensemble_2040_585_MPI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2040_585_MPI,
...
GR_SpheCoop_proj_ensemble_2100_585_MPI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2100_585_MPI,
                        projection.output = GR_SpheCoop_proj_2040_585_MPI,
...
#---------------------------------------------------------
# Get the ensemble models projection stack
GR_stk_SpheCoop_ef_current_MPI <- get_predictions(GR_SpheCoop_proj_ensemble_current)
plot(GR_stk_SpheCoop_ef_current_MPI)
GR_stk_SpheCoop_ef_2040_126_MPI <- get_predictions(GR_SpheCoop_proj_ensemble_2040_126_MPI)
plot(GR_stk_SpheCoop_ef_2040_126_MPI)
GR_stk_SpheCoop_ef_2100_126_MPI <- get_predictions(GR_SpheCoop_proj_ensemble_2100_126_MPI)
plot(GR_stk_SpheCoop_ef_2100_126_MPI)
GR_stk_SpheCoop_ef_2040_585_MPI <- get_predictions(GR_SpheCoop_proj_ensemble_2040_585_MPI)
plot(GR_stk_SpheCoop_ef_2040_585_MPI)
GR_stk_SpheCoop_ef_2100_585_MPI <- get_predictions(GR_SpheCoop_proj_ensemble_2100_585_MPI)
...
REU_SpheCoop_proj_ensemble_2040_126_MPI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2040_126_MPI,
...
REU_SpheCoop_proj_ensemble_2100_126_MPI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2100_126_MPI,
...
REU_SpheCoop_proj_ensemble_2040_585_MPI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2040_585_MPI,
...
REU_SpheCoop_proj_ensemble_2100_585_MPI <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2100_585_MPI,
...
#---------------------------------------------------------
# Get the ensemble models projection stack
REU_stk_SpheCoop_ef_current_MPI <- get_predictions(REU_SpheCoop_proj_ensemble_current)
plot(REU_stk_SpheCoop_ef_current_MPI)
REU_stk_SpheCoop_ef_2040_126_MPI <- get_predictions(REU_SpheCoop_proj_ensemble_2040_126_MPI)
plot(REU_stk_SpheCoop_ef_2040_126_MPI)
REU_stk_SpheCoop_ef_2100_126_MPI <- get_predictions(REU_SpheCoop_proj_ensemble_2100_126_MPI)
plot(REU_stk_SpheCoop_ef_2100_126_MPI)
REU_stk_SpheCoop_ef_2040_585_MPI <- get_predictions(REU_SpheCoop_proj_ensemble_2040_585_MPI)
plot(REU_stk_SpheCoop_ef_2040_585_MPI)
REU_stk_SpheCoop_ef_2100_585_MPI <- get_predictions(REU_SpheCoop_proj_ensemble_2100_585_MPI)
...
GR_SpheCoop_proj_ensemble_2040_126_UKESM <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2040_126_UKESM,
...
GR_SpheCoop_proj_ensemble_2100_126_UKESM <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2100_126_UKESM,
                        projection.output = GR_SpheCoop_proj_2040_126_UKESM,
...
GR_SpheCoop_proj_ensemble_2040_585_UKESM <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2040_585_UKESM,
...
GR_SpheCoop_proj_ensemble_2100_585_UKESM <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = GR_clim_2100_585_UKESM,
                        projection.output = GR_SpheCoop_proj_2040_585_UKESM,
...
#---------------------------------------------------------
# Get the ensemble models projection stack
GR_stk_SpheCoop_ef_current_UKESM <- get_predictions(GR_SpheCoop_proj_ensemble_current)
plot(GR_stk_SpheCoop_ef_current_UKESM)
GR_stk_SpheCoop_ef_2040_126_UKESM <- get_predictions(GR_SpheCoop_proj_ensemble_2040_126_UKESM)
plot(GR_stk_SpheCoop_ef_2040_126_UKESM)
GR_stk_SpheCoop_ef_2100_126_UKESM <- get_predictions(GR_SpheCoop_proj_ensemble_2100_126_UKESM)
plot(GR_stk_SpheCoop_ef_2100_126_UKESM)
GR_stk_SpheCoop_ef_2040_585_UKESM <- get_predictions(GR_SpheCoop_proj_ensemble_2040_585_UKESM)
plot(GR_stk_SpheCoop_ef_2040_585_UKESM)
GR_stk_SpheCoop_ef_2100_585_UKESM <- get_predictions(GR_SpheCoop_proj_ensemble_2100_585_UKESM)
...
REU_SpheCoop_proj_ensemble_2040_126_UKESM <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2040_126_UKESM,
...
REU_SpheCoop_proj_ensemble_2100_126_UKESM <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2100_126_UKESM,
...
REU_SpheCoop_proj_ensemble_2040_585_UKESM <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2040_585_UKESM,
...
REU_SpheCoop_proj_ensemble_2100_585_UKESM <- BIOMOD_EnsembleForecasting(
                        bm.em = ch_SpheCoop_ensemble,
                        new.env = REU_clim_2100_585_UKESM,
...
#---------------------------------------------------------
# Get the ensemble models projection stack
REU_stk_SpheCoop_ef_current_UKESM <- get_predictions(REU_SpheCoop_proj_ensemble_current)
plot(REU_stk_SpheCoop_ef_current_UKESM)
REU_stk_SpheCoop_ef_2040_126_UKESM <- get_predictions(REU_SpheCoop_proj_ensemble_2040_126_UKESM)
plot(REU_stk_SpheCoop_ef_2040_126_UKESM)
REU_stk_SpheCoop_ef_2100_126_UKESM <- get_predictions(REU_SpheCoop_proj_ensemble_2100_126_UKESM)
plot(REU_stk_SpheCoop_ef_2100_126_UKESM)
REU_stk_SpheCoop_ef_2040_585_UKESM <- get_predictions(REU_SpheCoop_proj_ensemble_2040_585_UKESM)
plot(REU_stk_SpheCoop_ef_2040_585_UKESM)
REU_stk_SpheCoop_ef_2100_585_UKESM <- get_predictions(REU_SpheCoop_proj_ensemble_2100_585_UKESM)
